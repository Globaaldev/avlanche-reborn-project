  ...
  return (
    <div className="relative flex-1 flex items-center justify-center">
      ...
      >
        ...
        <p className="text-foreground/60 text-lg sm:text-xl md:text-2xl font-normal leading-relaxed tracking-wide">
          Production / Edition
        </p>
      </motion.div>
      ...
      >
        ...
        >
          <a
            href="/artistes"
            className="story-link text-red-500 text-base md:text-xl tracking-[0.2em] font-normal transition-all duration-300 uppercase hover:tracking-[0.35em]"
          >
            ARTISTES
          </a>
          <div
          ...
          >
            {ARTISTS.map((artist) => (
              <a
                ...
                className="text-foreground text-sm md:text-base tracking-[0.15em] font-normal hover:opacity-70 transition-opacity py-1 whitespace-nowrap"
              >
                {artist.name}
              </a>
            ))}
